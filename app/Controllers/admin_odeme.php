...
class admin_odeme extends BaseController
{
    public function index()
    {

        $db=\Config\Database::connect();
        $query=$db->query("SELECT kart_adi,odeme_miktari,kredi_karti_numarasi,son_tarih,cvv  FROM `ödemeler` ");
        ...
        if (!empty($result)) {
            ...
            echo '<tr>';
            echo '<th>Kart Adı</th>';
            echo '<th>Ödeme Miktarı</th>';
            echo '<th>Kredi Kartı Numarası</th>';
            ...
            foreach ($result as $row) {
                echo '<tr>';
                echo '<td>' . $row['kart_adi'] . '</td>';
                echo '<td>' . $row['odeme_miktari'] . '</td>';
                echo '<td>' . $row['kredi_karti_numarasi'] . '</td>';
