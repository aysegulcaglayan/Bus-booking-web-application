...
class UserLogin extends BaseController
{
    public function index()
    {
        ...
        $query=$db->query("SELECT * FROM `kullanıcılar` WHERE e_mail='$email'");
        $result=$query->getResult();

        
        foreach($result as $row){
           if($password==$row->şifre){
 ...
 <div class="login-box" style="background-color:rgba(76, 72, 72, 0.5)">
    <img src="İmages/avatar.png" class="avatar">
        <h1 style="color:black">UMUTTEPE TURİZM</h1>
            ...
            <input  style="color:black"type="text" name="email" id="email" placeholder="E-mail">
            ...
            <a href="signUp" class="sign_up">Kayıt Ol</a>&nbsp&nbsp&nbsp
